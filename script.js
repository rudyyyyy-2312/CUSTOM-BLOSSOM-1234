        ...
        /* — SCROLL THEMES DATA — */
        const SCROLL_THEMES = [
            { id: 'anime', name: 'Anime', emoji: 'ChatGPT Image May 2, 2026, 09_15_16 PM.png', img: 'ChatGPT Image May 2, 2026, 09_15_16 PM.png', tag: 'Fan Favourites', desc: 'Bring your favourite characters to life. From Naruto to Demon Slayer — wear your fandom with pride.', accent: '#F8C8DC', accent2: '#E6E6FA', bg: 'linear-gradient(135deg,#FFF0F5,#E6E6FA)', designs: [{ name: 'Sakura Vibes', color: '#F8C8DC', icon: '/images/icon_designs.png' }, { name: 'Thunder Storm', color: '#E6E6FA', icon: '/images/icon_designs.png' }, { name: 'Night Slash', color: '#C9B8E8', icon: '/images/icon_designs.png' }] },
